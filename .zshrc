...
alias gicb='git commit -m "bruh, fix stupid bugs"'
alias gicf='git commit -m "commit and going for a fika, hejdå!"'
alias gicm='git commit -m "Fixes a bug where your mother would delete your species after calling you a disappointment, rendering you a broken husk of a mob"'
alias gicr='git commit -m "update README"'
